...
export class NewConnectionComponent {
  ...
  datasetCategories: DataSetCategories[];
    ...
    constructor(private dialogRef: MatDialog, private formDataService: FormService, private sharedService: SharedService) {
  ...
  filter(category: string) {
    ...
    if (category == "All") {
      ...
      this.datasetCategories = dataSetCategories.filter(s => s.category == category);
    }
  }
  ...
  getTotalCategoryTypeCount(): number {
    return dataSetCategories.reduce((total, category) => total + category.categoryType.length, 0);
  }

}

// const categories: NewConnectionCategories[] = [
//   { id: 1, category: 'databases' },
//   { id: 2, category: 'productivityapps' },
//   { id: 3, category: 'plugins' },
//   { id: 4, category: 'cloudstorage' },
//   { id: 5, category: 'Test & Inspiration' },
//   { id: 6, category: 'Robotic' },
//   { id: 7, category: 'IoT Sensors' },
//   { id: 8, category: 'CAD ' },
//   { id: 11, category: 'databases ' },
//   { id: 9, category: 'file managers' },
//   { id: 10, category: 'MES' },
// ];
